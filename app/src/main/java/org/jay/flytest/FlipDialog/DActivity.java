...
public class DActivity extends AppCompatActivity {
    ...
    private void initOpenAnim() {
        ...
        openAnimation = new Rotate3dAnimation(this,0, 90, centerX, centerY, depthZ, true);
        ...
        openAnimation.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                Rotate3dAnimation rotateAnimation = new Rotate3dAnimation(DActivity.this,270, 360, centerX, centerY, depthZ, false);
    ...
    private void initCloseAnim() {
        closeAnimation = new Rotate3dAnimation(this,360, 270, centerX, centerY, depthZ, true);
        ...
        closeAnimation.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                Rotate3dAnimation rotateAnimation = new Rotate3dAnimation(DActivity.this,90, 0, centerX, centerY, depthZ, false);
                rotateAnimation.setDuration(duration);
                rotateAnimation.setFillAfter(true);
                rotateAnimation.setInterpolator(new DecelerateInterpolator());
                mContentRl.startAnimation(rotateAnimation);
